...
CAction_Patrol::CAction_Patrol(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CSequence(pDevice, pContext)
{
}

CAction_Patrol::CAction_Patrol(const CAction_Patrol& rhs)
	: CSequence(rhs)
{
}

HRESULT CAction_Patrol::Initialize(const _uint& iLevelIndex, CComponent* pOwner, void* pArg)
{
...
HRESULT CAction_Patrol::Assemble_Childs()
{
...
CAction_Patrol* CAction_Patrol::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CAction_Patrol* pInstance = new CAction_Patrol(pDevice, pContext);
...
CAction_Patrol* CAction_Patrol::Clone(const _uint& iLevelIndex, CComponent* pOwner, void* pArg)
{
	CAction_Patrol* pInstance = new CAction_Patrol(*this);
