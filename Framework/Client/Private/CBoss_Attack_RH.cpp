...
CBoss_Attack_RH::CBoss_Attack_RH(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CBehavior(pDevice, pContext)
{
}

CBoss_Attack_RH::CBoss_Attack_RH(const CBoss_Attack_RH& rhs)
	: CBehavior(rhs)
{
}

HRESULT CBoss_Attack_RH::Initialize(const _uint& iLevelIndex, CComponent* pOwner, void* pArg)
{
...
CBoss_Attack_RH* CBoss_Attack_RH::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CBoss_Attack_RH* pInstance = new CBoss_Attack_RH(pDevice, pContext);
...
CBoss_Attack_RH* CBoss_Attack_RH::Clone(const _uint& iLevelIndex, CComponent* pOwner, void* pArg)
{
	CBoss_Attack_RH* pInstance = new CBoss_Attack_RH(*this);
