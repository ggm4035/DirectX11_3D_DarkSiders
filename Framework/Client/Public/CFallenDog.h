...
{
private:
	explicit CFallenDog(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
...
public:
	static CFallenDog* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual CFallenDog* Clone(const _uint& iLevelIndex, CComponent* pOwner, void* pArg) override;
