...
HRESULT CTexture::Initialize(const _uint& iLayerIndex, CComponent* pOwner, void* pArg)
{
...
CComponent* CTexture::Clone(const _uint& iLayerIndex, CComponent* pOwner, void* pArg)
{
